...
from src.common import (get_camera_from_tensor, get_samples,
                        get_samples_uniform, get_tensor_from_camera)
...
class Tracker(object):
    ...
    def optimize_cam_in_batch(self, camera_tensor, gt_color, gt_depth, batch_size, optimizer):
        ...
        #         self.c, self.decoders, batch_rays_d, batch_rays_o, batch_gt_depth, device)
    ...
    def run(self):
        ...
        for idx, gt_color, gt_depth, gt_c2w in pbar:
            ...
            if self.sync_method == 'strict':
                ...
                if idx > 0 and (idx % self.every_frame == 1 or self.every_frame == 1 or idx < 14):
